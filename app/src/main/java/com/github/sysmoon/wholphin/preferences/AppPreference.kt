...
import com.github.sysmoon.wholphin.ui.preferences.ConditionalPreferences
...
import com.github.sysmoon.wholphin.ui.preferences.PreferenceValidation
...
//            )
        ...
        val UpdateUrl =
            AppStringPreference<AppPreferences>(
                ...
                defaultValue = "https://api.github.com/repos/sysmoon14/Wholphin/releases/latest",
                getter = { it.updateUrl },
                setter = { prefs, value ->
