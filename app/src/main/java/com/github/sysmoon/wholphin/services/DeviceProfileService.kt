...
import com.github.sysmoon.wholphin.util.profile.MediaCodecCapabilitiesTest
import com.github.sysmoon.wholphin.util.profile.createDeviceProfile
                ...
                mutex.withLock {
                    val newConfig =
                        DeviceProfileConfiguration(
                            ...
                            ignoreDoviValidation = prefs.overrides.ignoreDoviValidation,
                    ...
                    if (deviceProfile == null || this@DeviceProfileService.configuration != newConfig) {
                        ...
                        this@DeviceProfileService.deviceProfile =
                            createDeviceProfile(
                                ...
                                ignoreDoviValidation = newConfig.ignoreDoviValidation,
                                decodeAv1 = prefs.overrides.decodeAv1,
...
data class DeviceProfileConfiguration(
    ...
    val ignoreDoviValidation: Boolean,
