...
import com.github.sysmoon.wholphin.ui.cards.EpisodeCard
import com.github.sysmoon.wholphin.ui.cards.ItemRow
import com.github.sysmoon.wholphin.ui.cards.SeasonCard
import com.github.sysmoon.wholphin.ui.components.SearchEditTextBox
...
import com.github.sysmoon.wholphin.ui.components.VoiceSearchButton
...
import com.github.sysmoon.wholphin.util.SearchRelevance
    ...
    item {
        when (val r = result) {
            ...
            is SearchResult.Success -> {
                // Only show if there are actual items (hide empty categories)
                // ApiRequestPager.init() sets totalCount to 0 if no results, so size will be 0
                // For regular lists, isEmpty() works fine
                val itemCount = r.items.size
                if (itemCount > 0) {
                    ItemRow(
                        title = title,
                        items = r.items,
                ...
                // If itemCount is 0, don't show anything (no placeholder)
            }
